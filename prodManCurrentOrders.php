                            ...
                            <br><br>
                                ...
                                <table  id="myTable" class="table table-hover">
                                    <thead>
                                        ...
                                        <th onclick="sortTable(1)"><p class="category"><b>DATE ORDERED</b></p></th>
                                         <th onclick="sortTable(2)" ><p class="category"><b>CLIENT</b></p></th>
                                        <th onclick="sortTable(3)"><p class="category"><b>PAYMENT STATUS</b></p></th>
                                        <th onclick="sortTable(4)" ><p class="category"><b>MANUFACTURING STATUS</b></p></th>

                                        <th onclick="sortTable(5)"><p class="category"><b>DATE REQUIRED</b></p></th>
                                    </thead>
<?php
