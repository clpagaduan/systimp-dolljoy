            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Enter employee details</h4>
                            </div>    
                            <div class="content table-responsive table-full-width">
                                 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                <div class="form-group">
                                    <input class="form-control" placeholder="Employee Name" name="EmpName" type="text" autofocus="" value="<?php if (isset($_POST['EmpName']) && !$flag) echo $_POST['EmpName']; ?>"/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Employee Contact Number" name="EmpContactNo" type="number" autofocus=""value="<?php if (isset($_POST['EmpContactNo']) && !$flag) echo $_POST['EmpContactNo']; ?>"/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Employee E-mail" name="EmpEmailAdd" type="email" autofocus="" value="<?php if (isset($_POST['EmpEmailAdd']) && !$flag) echo $_POST['EmpEmailAdd']; ?>"/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="User name" name="EmpUsername" type="text" autofocus="" value="<?php if (isset($_POST['EmpUsername']) && !$flag) echo $_POST['EmpUsername']; ?>"/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="EmpPassword" type="password" autofocus="" value="<?php if (isset($_POST['EmpPassword']) && !$flag) echo $_POST['EmpPassword']; ?>"/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Confirm Password" name="pass2" type="password" autofocus="" value="<?php if (isset($_POST['pass2']) && !$flag) echo $_POST['pass2']; ?>"/>
                                </div>
                                <!-- Change this to a button or input when using this as a form -->
                                <br>&nbsp;
                                <a href="javascript:;" class="btn btn-sm btn-success" type="submit" name ="submit">Add employee account</a>  
                                <br><br>
