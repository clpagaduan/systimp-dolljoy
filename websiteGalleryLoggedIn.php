    ...
    <div class="content">
        <div class="containter-fluid">
            <div class="row">
                <div class="col-md=12">
                    <div class="card">
                        <div class="content table-responsive table-full-width" style="width:100%; display: inline-block; overflow-y:hidden;overflow-x:scroll;">
                            <table class="table table-hover" >
                                ...
                                <td><div class=card style="border:1px white; width:275px">
                                    ...
                                    /*
                                    <input type="number" value="1" min="1" style="resize:horizontal; width:50px" align:"middle">
                                    <input type="submit" name="add" class="btn btn-success btn-fill" value="Add to Cart" style="margin:auto; text-align:center; display:block"  />
